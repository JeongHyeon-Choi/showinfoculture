...
<body onload="myLocation()">
	...
	<table align="center" style="width: 900px" cellpadding="0"
		cellspacing="1">

		<tr>
			<th colspan="3" align="center"><h2>
					<font face="휴먼매직체">&#9829;&nbsp;&nbsp; ${perForInfo.title}
						&nbsp;&nbsp;&#9829;</font>
				</h2>
		...
		<tr>
			<td width="300" rowspan="9"><img src="${perForInfo.imgUrl}"
				style="width: 300px; height: 450px"></td>
		</tr>

		<tr>
			<td width="150"><img src="resources/images/date.png"></td>
			<td width="300"><h3>
					<font face="휴먼매직체">${perForInfo.startDate} ~
						${perForInfo.endDate}</font>
				</h3></td>
		</tr>
		<tr>
			<td><img src="resources/images/loca.png"></td>
			<td><h3>
					<font face="휴먼매직체"> ${perForInfo.place}</font>
				</h3></td>
		</tr>
		<tr>
			<td><img src="resources/images/genre.png"></td>
			<td><h3>
					<font face="휴먼매직체"> ${perForInfo.realmName}</font>
				</h3></td>
		</tr>
		<tr>
			<td><img src="resources/images/price.png"></td>
			<td><h3>
					<font face="휴먼매직체"> ${perForInfo.price}</font>
				</h3></td>
		</tr>
		<tr>
			<td><img src="resources/images/call.png"></td>
			<td><h3>
					<font face="휴먼매직체">${perForInfo.phone}</font>
				</h3></td>
		</tr>
		...
		<tr>
			...
			<c:if test="${perForInfo.discountRate != ''}">
				<td><h3>
						<font face="휴먼매직체">Discount</font>
					</h3></td>
			</c:if>

			<c:if test="${perForInfo.discountRate == ''}">
				<td><h3>
						<font face="휴먼매직체">Not</font>
					</h3></td>
			</c:if>
		</tr>
		...
		<c:if test="${perForInfo.discountRate != ''}">
			<tr>
				...
				<td><h3>
						<font face="휴먼매직체">${perForInfo.discountRate}%</font>
					</h3></td>
			</tr>
			...
			<tr>
				...
				<td><h4>
						<font face="휴먼매직체"><a href="${perForInfo.ticketImg}">할인쿠폰다운</a></font>
					</h4></td>
			</tr>
			...
			<tr>
				...
				<br>
				<hr size="3" color="black"></td>
			</tr>
		</c:if>
	</table>
	<table align="center">
		<%
			String url = javax.servlet.http.HttpUtils.getRequestURL(request)
					.toString();
		%>
	...
	<table width="1000" align="center" cellspacing="30">
		<tr>
			<td><img src="resources/images/about.png" onclick="about()"
				style="cursor: pointer;"></td>
			<td><img src="resources/images/how.png" onclick="how()"
				style="cursor: pointer;"></td>
