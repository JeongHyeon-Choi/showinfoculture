...
<div id="header">
	...
	<td >
		...
		<input name="search" type="text" style="border: #870073 4px solid; height:40px; width:350px;  font-size:20px; font-family:MD아롱체 font-weight:bold; padding:10 0 0 0; margin:0 0 0 0;" > 
